...
__author__ = 'kimvais'
logger = logging.getLogger('Challenge 19')
PLAINTEXTS = [base64.b64decode(x) for x in """SSBoYXZlIG1ldCB0aGVtIGF0IGNsb3NlIG9mIGRheQ==
...
def encrypt():
    return [aes.CTR(b'YELLOW SUBMARINE').encrypt(pt) for pt in PLAINTEXTS]
